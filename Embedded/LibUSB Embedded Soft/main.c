...
{   
    ...
    {   
        switch(OUTPacket[0])					//Data arrived, check what kind of command might be in the packet of data.
        {
            ...
            case 0x82:
            	INPacket[0] = 0x82;
            	INPacket[1] = (sw2?0x00:0x01) | (sw3?0x00:0x02) | (sw4?0x00:0x04) | (sw5?0x00:0x08);
            ...
            case 0x83:
            	blinkStatusValid = FALSE;
           		mLED_1 = OUTPacket[1] & 0x01 ? 0x01 : 0x00;
            	mLED_2 = OUTPacket[1] & 0x02 ? 0x01 : 0x00;
            	mLED_3 = OUTPacket[1] & 0x04 ? 0x01 : 0x00;
            	mLED_4 = OUTPacket[1] & 0x08 ? 0x01 : 0x00;
            	mLED_5 = OUTPacket[1] & 0x10 ? 0x01 : 0x00;
            	mLED_6 = OUTPacket[1] & 0x20 ? 0x01 : 0x00;
            	mLED_7 = OUTPacket[1] & 0x40 ? 0x01 : 0x00;
            	break;
        }

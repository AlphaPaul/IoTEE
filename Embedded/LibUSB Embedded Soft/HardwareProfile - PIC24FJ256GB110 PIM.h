...
#define HARDWARE_PROFILE_PIC24FJ256GB110_PIM_H
    ...
    /** LED ************************************************************/
    #define mInitAllLEDs()      LATA &= 0x80; TRISA &= 0x80;
    ...
    #define mLED_5_Toggle()     mLED_1 = !mLED_5;
    #define mLED_6_Toggle()     mLED_2 = !mLED_6;
    #define mLED_7_Toggle()     mLED_3 = !mLED_7;
    
    /** SWITCH *********************************************************/
    #define mInitSwitch2()      TRISDbits.TRISD6=1;
    #define mInitSwitch3()      TRISDbits.TRISD7=1;
    #define mInitSwitch4()      TRISAbits.TRISA7=1;
    #define mInitSwitch5()      TRISDbits.TRISD13=1;
    #define mInitAllSwitches()  mInitSwitch2();mInitSwitch3();mInitSwitch4();mInitSwitch5();
    #define sw2                 PORTDbits.RD6
    #define sw3                 PORTDbits.RD7
    #define sw4					PORTAbits.RA7
    #define sw5					PORTDbits.RD13
